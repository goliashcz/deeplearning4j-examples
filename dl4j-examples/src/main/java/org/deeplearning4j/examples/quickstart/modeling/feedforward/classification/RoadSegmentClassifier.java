...
public class RoadSegmentClassifier {
    ...
    public static void main(String[] args) throws  Exception {
        ...
        int labelIndex = 14;     // CSV has 15 columns, the last column is label
        int numClasses = 1;     // 0.0 to 1.0
        int batchSize = 150;    // We are loading all of them into one DataSet (not recommended for large data sets)
        ...
        int secondLayerInputs = 7; // 13
        int thirdLayerInputs = 7; // 5
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
            ...
            .layer(new OutputLayer.Builder(LossFunctions.LossFunction.XENT)
                .nIn(thirdLayerInputs).nOut(outputNum).activation(Activation.SIGMOID).build()) //output layer, signmoid activation + binary cross entropy loss function
/*            .layer(new OutputLayer.Builder(LossFunctions.LossFunction.MSE)
        ...
        // write model together with normalizer
